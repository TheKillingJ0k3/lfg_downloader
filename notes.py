...
filename = '.\\Downloaded Comics\\comic_dates_A_to_D.json' # change when file is ready
...
def set_comic_title_var(event):
    ...
    # res.raise_for_status()
    # soup = bs4.BeautifulSoup(res.text, 'html.parser')
    download_page(chosen_comic_url) # download current page of chosen comic
